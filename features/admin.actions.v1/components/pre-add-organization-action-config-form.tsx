...
import "./pre-add-organization-action-config-form.scss";

/**
 * Prop types for the action configuration form component.
 */
interface PreAddOrganizationActionConfigFormInterface extends IdentifiableComponentInterface {
    /**
...
const PreAddOrganizationActionConfigForm: FunctionComponent<PreAddOrganizationActionConfigFormInterface> = ({
    initialValues,
    isLoading,
    isReadOnly,
    actionTypeApiPath,
...
}: PreAddOrganizationActionConfigFormInterface): ReactElement => {
    ...
    const showRuleComponent: boolean = isFeatureEnabled(
        actionsFeatureConfig, ActionsConstants.FEATURE_DICTIONARY.get("PRE_ADD_ORGANIZATION_RULE"));
    ...
    const showHeadersAndParams: boolean = isFeatureEnabled(
        actionsFeatureConfig, ActionsConstants.FEATURE_DICTIONARY.get("PRE_ADD_ORGANIZATION_HEADERS_AND_PARAMS"));
...
export default PreAddOrganizationActionConfigForm;
